...
-   If you want to highlight a potential bug, we suggest posting it as an issue on one of the Github repos
-   You can use the Discussions page on the `odin-monty` repo: [https://github.com/mrc-ide/odin-monty/discussions](https://github.com/mrc-ide/odin-monty/discussions)